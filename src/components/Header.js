            ...
            <div className={toggle ? "nav-menu show-menu" : "nav-menu"}>
                <ul className="nav-list grid">
                    <li className="nav-item">
                        <a style={{fontWeight:"bold"}} href="#home" onClick={() => setActivenav('#home')} className={activenav === "#home" ? "nav-link active-link" : "nav-link"}>
                    ...
                    <li className="nav-item">
                        <a href="#qualification" onClick={() => setActivenav('#qualification')} className={activenav === "#qualification" ? "nav-link active-link" : "nav-link"}>
                ...
                <i class="uil uil-times nav-close" onClick={() => setToggle(!toggle)}></i>
            </div>
