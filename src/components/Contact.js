        ...
        <div className="contact-content">
          ...
          <div className="contact-info">
            <div className="contact-card">
              ...
              <p style={{ cursor: "pointer" }} className="contact-button">
                Connect{" "}
            ...
            <div className="contact-card">
              ...
              <span className="contact-card-data">+91 7902360099</span>

              <a
                target="_blank"
                rel="noreferrer"
                href="https://api.whatsapp.com/send?phone=7902360099&text=Hello, more information"
            ...
            <div className="contact-card">
              ...
              <span className="contact-card-data">@althaf.kv_</span>
